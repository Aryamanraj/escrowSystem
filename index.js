...
// Export contract properties
const { target, interface, runner, filters, fallback } = contract;
// Save contract properties to a JSON file
const contractData = {
  target,
  interface,
  runner,
...
console.log("done here 2", typeof(contractData))

const contractJson = JSON.stringify(contractData);


fs.writeFileSync('./contract.json', contractJson);
